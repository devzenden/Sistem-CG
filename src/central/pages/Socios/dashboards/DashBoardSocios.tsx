...
//const BeneficiaryMap = dynamic(() => import(".beneficiary-map"), { ssr: false })
const BeneficiaryMap = lazy(() => import("./beneficiary-map"))
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            <BeneficiaryMap filters={{ status, gfnType, selectedZones, selectedDistritos, selectedTipoInst }} />
          </CardContent>
        </Card>
